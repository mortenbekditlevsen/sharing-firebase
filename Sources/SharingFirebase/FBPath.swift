...
public struct EncodingOptions: Sendable, Hashable {
    public init(dateEncodingStrategy: DateEncodingStrategy = .deferredToDate,
                ...
                userInfo: [CodingUserInfoKey : any Sendable & Hashable] = [:]) {
...
//        self.userInfo = userInfo
    ...
    public enum DateEncodingStrategy: Sendable, Hashable {
        ...
        /// TODO: How can this be made Hashable?
//        case custom(@Sendable (Date, Swift.Encoder) throws -> Void)
    }
    ...
    public enum DataEncodingStrategy: Sendable, Hashable {
        ...
        /// If the closure fails to encode a value into the given encoder, the encoder will encode an empty automatic container in its place.
        /// TODO: How can this be made Hashable?
//        case custom(@Sendable (Data, Swift.Encoder) throws -> Void)
    }
    
    /// The strategy to use for non-JSON-conforming floating-point values (IEEE 754 infinity and NaN).
    public enum NonConformingFloatEncodingStrategy: Sendable, Hashable  {
    ...
    public enum KeyEncodingStrategy: Sendable, Hashable {
...
//    public let userInfo: [CodingUserInfoKey : any Sendable & Hashable]
...
public struct DecodingOptions: Sendable, Hashable {
    public init(
...
//        self.userInfo = userInfo
    ...
    public enum DateDecodingStrategy: Sendable, Hashable {
        ...
        /// TODO: How can this be made Hashable?
//        case custom(@Sendable (_ decoder: Swift.Decoder) throws -> Date)
    }
    ...
    public enum DataDecodingStrategy: Sendable, Hashable {
        ...
        /// TODO: How can this be made Hashable?
//        case custom(@Sendable (_ decoder: Swift.Decoder) throws -> Data)
    }
    
    /// The strategy to use for non-JSON-conforming floating-point values (IEEE 754 infinity and NaN).
    public enum NonConformingFloatDecodingStrategy: Sendable, Hashable {
        /// Throw upon encountering non-conforming values. This is the default strategy.
        case `throw`
    ...
    public enum KeyDecodingStrategy: Sendable, Hashable {
        /// Use the keys specified by each type. This is the default strategy.
        case useDefaultKeys
...
//    public var userInfo: [CodingUserInfoKey : any Sendable & Hashable] = [:]
...
public struct FirestoreConfig: Sendable, Hashable {
    public init(
        database: String? = nil,
    ...
    public static let `default`: FirestoreConfig = .init()
}

public struct RTDBConfig: Sendable, Hashable {
    public init(
        regionId: String? = nil,
    ...
    public static let `default`: RTDBConfig = .init()
}

public enum PathConfig: Sendable, Hashable {
    case firestore(FirestoreConfig)
    case rtdb(RTDBConfig)
    
    public static var firestore: PathConfig { .firestore(.default) }
    public static var rtdb: PathConfig { .rtdb(.default) }
}
...
public struct FBQuery<Element> {
    public var path: CollectionPath<Element>
    public var limit: Int?
}

public struct FBPath<Element>: Sendable, Hashable {
...
//    public var query: FBQuery?
    ...
    fileprivate func _limit(_ limit: Int) -> FBQuery<Element> {
        var query: FBQuery<Element> = FBQuery(path: CollectionPath(fsComponents: fsComponents, rtdbComponents: rtdbComponents, config: config))
        query.limit = limit
        return query
    }
...
public typealias CollectionPath<T> = FBPath<FirebasePaths.Collection<T>>
...
extension FBPath where Element == FirebasePaths.Root {
    public init() {
        self.fsComponents = []
        self.rtdbComponents = []
        self.config = .firestore
    }
...
extension FBPath where Element: CollectionPathProtocol {
    public func child(_ key: String) -> FBPath<Element.Element> {
        append(key)
    }

    /* Note: Experimental. Sometime it perhaps does not make sense to have a default
     value? */
//    public func child(_ key: String) -> FBPath<Element.Element?> {
//        append(key)
//    }
    
    public func limit(_ limit: Int) -> FBQuery<Element.Element> {
        var query: FBQuery<Element.Element> = FBQuery(path: CollectionPath(fsComponents: fsComponents, rtdbComponents: rtdbComponents, config: config))
        query.limit = limit
        return query
    }
}
